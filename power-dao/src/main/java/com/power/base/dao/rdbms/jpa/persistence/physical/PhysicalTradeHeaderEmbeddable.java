package com.power.base.dao.rdbms.jpa.persistence.physical;
...
public class PhysicalTradeHeaderEmbeddable implements Serializable {
    ...
    private PhysicalPartyEmbeddable buyerParty;
    ...
    private PhysicalPartyEmbeddable sellerParty;
    ...
    public PhysicalPartyEmbeddable getBuyerParty() {
        return buyerParty;
    }

    public void setBuyerParty(PhysicalPartyEmbeddable buyerParty) {
        this.buyerParty = buyerParty;
    }

    public PhysicalPartyEmbeddable getSellerParty() {
        return sellerParty;
    }

    public void setSellerParty(PhysicalPartyEmbeddable sellerParty) {
