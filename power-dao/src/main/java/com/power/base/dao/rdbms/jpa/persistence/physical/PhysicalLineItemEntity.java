...
public class PhysicalLineItemEntity {
    ...
    @Column(name = "period_start_epoch")
    private Long periodStartEpochMillis;
    ...
    @Column(name = "period_end_epoch")
    private Long periodEndEpochMillis;
    ...
    public void setPeriodStartTime(Instant periodStartTime) {
        ...
        this.periodStartEpochMillis = periodStartTime == null ? null : periodStartTime.toEpochMilli();
    }
    ...
    public void setPeriodEndTime(Instant periodEndTime) {
        ...
        this.periodEndEpochMillis = periodEndTime == null ? null : periodEndTime.toEpochMilli();
    }
